...
class InputBox:
    ...
    def draw(self, surface, theme=None):
        ...
        pygame.draw.rect(surface, border if not self.active else theme.get("button_selected", GOLD), self.rect, 2, border_radius=8)
        if self.text:
...
theme_toggle_btn = Button(WIDTH - 180, 20, 160, 40, "Light Mode")
